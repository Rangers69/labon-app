...
class Dashboard extends Component
{
    public function render()
    {
        ...
        $count_diterima = Transaksi::all()->count();
        $count_dicuci = Transaksi::where('status', 3)->count();
        $count_dikeringkan = Transaksi::where('status', 2)->count();
        $count_disetrika = Transaksi::where('status', 3)->count();
        $count_menunggu = Transaksi::where('status', 1)->count();
        $count_selesai = Transaksi::where('status', 6)->count();

        $selesai = Transaksi::latest()->limit(10)->where('status', 6)->get();
